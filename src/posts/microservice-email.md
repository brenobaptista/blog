...
![Interaction between email and users services](/images/model-for-microservices-oriented-email-service/interaction-email-users.svg)
...
![Basic tables](/images/model-for-microservices-oriented-email-service/basic-tables.svg)
...
![Engine for email service](/images/model-for-microservices-oriented-email-service/engine-email.svg)
...
![Model for email service](/images/model-for-microservices-oriented-email-service/model-email.svg)
